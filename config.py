...
# --- Database Connection ---
DB_HOST = os.environ.get('DB_HOST', 'saayam-dev-rds.cdqs8g6owlt0.us-east-1.rds.amazonaws.com')
DB_PORT = os.environ.get('DB_PORT', 5432)
DB_NAME = os.environ.get('DB_NAME', 'virginia_dev_saayam_rdbms')
DB_USER = os.environ.get('DB_USER', 'spatial_user')
DB_PASSWORD = os.environ.get('DB_PASSWORD', 'Saayam#123')
